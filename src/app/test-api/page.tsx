...
// 将环境变量提升到模块作用域并声明类型
const OPENROUTER_API_KEY: string | undefined = process.env.NEXT_PUBLIC_OPENROUTER_API_KEY;
const YOUR_SITE_URL: string | undefined = process.env.NEXT_PUBLIC_SITE_URL;
const YOUR_SITE_NAME: string | undefined = process.env.NEXT_PUBLIC_SITE_NAME;
