...
export const buildingAgeCriteria = [
  ...
  { id: "A2", label: "5-10年", min: 90, max: 94 },
  { id: "B1", label: "10-15年", min: 80, max: 89 },
  { id: "B2", label: "15-20年", min: 70, max: 79 },
  { id: "C1", label: "20-25年", min: 60, max: 69 },
  { id: "C2", label: "25-30年", min: 50, max: 59 },
  { id: "D1", label: "30-40年", min: 40, max: 49 },
  { id: "D2", label: "40年以上", min: 30, max: 39 },
];
